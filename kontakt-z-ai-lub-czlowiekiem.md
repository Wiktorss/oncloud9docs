...
icon: phone-flip
description: >-
  Ta Knowledge Base opisuje system wsparcia onCloud9, gdzie AI diagnozuje
  problemy 24/7, a w razie potrzeby przekierowuje do formularza zgłoszeniowego z
  możliwością kontaktu z człowiekiem.
---

# Kontakt z AI lub człowiekiem
...
* **Co, jeśli AI nie rozwiąże mojego problemu?**\
  Jeśli AI nie będzie w stanie rozwiązać problemu, automatycznie zostaniesz przekierowany do formularza zgłoszeniowego. Wypełniając go, przekazujesz wszystkie niezbędne informacje, dzięki którym nasz zespół szybciej się z Tobą skontaktuje.
* **Co muszę podać w formularzu zgłoszeniowym?**\
  Formularz wymaga, abyś podał opis problemu, adres e-mail do kontaktu oraz maila przypisanego do Twojego konta (jeśli masz je u nas).
* **Czy mogę napisać, że chcę rozmawiać z człowiekiem?**\
  Tak! Jeśli wolisz bezpośredni kontakt, wystarczy, że napiszesz w czacie „Proszę o kontakt z człowiekiem” i nasz zespół skontaktuje się z Tobą najszybciej jak to możliwe.
* **Jakie problemy mogę zgłosić?**\
  Możesz zgłaszać wszelkie problemy dotyczące konfiguracji, optymalizacji wydajności, bezpieczeństwa czy problemów z pocztą i domenami.
